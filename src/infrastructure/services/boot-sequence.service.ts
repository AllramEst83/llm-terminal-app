import type { BootMessage } from '../../domain/entities/boot-sequence';

export class BootSequenceService {
  static readonly BOOT_MESSAGES: BootMessage[] = [
    { text: 'Coded By Kay BIOS v1.5.0 (c) 1988', delay: 200 },
    ...
    { text: 'Loading Coded By Kay OS...', delay: 600 },
  ...
  static getTotalBootDuration(): number {
    return this.BOOT_MESSAGES.reduce((total, msg) => total + msg.delay, 0) + 500;
  }
}
